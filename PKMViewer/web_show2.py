...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        #rebuild_button = QAction(QIcon('icons/shuaxin.png'), 'rebuild', self)
        ...
        #rebuild_button.triggered.connect(self.webview.reload)
        ...
        #navigation_bar.addAction(rebuild_button)
