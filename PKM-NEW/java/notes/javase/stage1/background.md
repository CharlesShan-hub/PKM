...
* JVM、JRE、JDK
  ...
  * JRE（Java Runtime Environment）= JVM + Java核心库。运行class文件需要安装JRE
  * JDK（Java Development Kit）= JRE + Java开发工具(比如javac)。Java开发者安装JDK就好了
...
* 代码规范
  ...
  * 官网介绍： https://docs.oracle.com/javase/specs/jls/se21/html/
