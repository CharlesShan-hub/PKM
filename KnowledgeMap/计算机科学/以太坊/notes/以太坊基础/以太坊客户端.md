...
自己的账户是```0x6118307A4f669b43beD30Bc785b93657B4c54F9A```,创世链的时候创建了4000以太
...
* 创建新账户,控制台输入```personal.newAccount()```, 然后会然我输入密码, 之后创建好了账户```"0x985efd5d83c10e1aac002ed02cfed645ce1edd36"```.

* 查看所有账户，就可以看到刚才创建的账户了，控制台输入```eth.accounts```, 控制台返回```["0x985efd5d83c10e1aac002ed02cfed645ce1edd36"]```.
