...
* 第 1 章：概述
    ...
    * 5：（可跳过）之前的PPT，总结成了笔记
* 第 2 章：[background](pkm/backend/java/javase/notes/00-introduction/background.md)，[hello-world](pkm/backend/java/javase/notes/00-introduction/hello-world.md)，[remember](pkm/backend/java/javase/notes/00-introduction/remember.md)，[dos](pkm/backend/java/javase/notes/00-introduction/dos.md)
    ...
    * 33：（可跳过）内容梳理
* 第 3 章：[variable-and-datatype](../notes/stage1/variable-and-datatype.md)，[package](../notes/stage1/package.md)，[coding](../notes/stage1/coding.md)
	* 34：（可跳过）变量原理：类型、名称、值
	* 35：（可跳过）变量概念：声明、赋值
	...
	* 45：JavaAPI文档：[[../notes/stage1/package|package]]
	* 46：（可跳过）char 可以放汉字，一些 sublime 快捷键
	* 47：字符型细节：ascii 码，char 就是数字 可以直接运算
	* 48：字符类型的本质：还是char 就是数字，[coding](../notes/stage1/coding.md)
	* 49：（可跳过）复习编码
	...
	* 61：（可跳过）章末总结
* 第 4 章：[operator](../notes/stage1/operator.md)，[keyboard-input](../notes/stage1/keyboard-input.md)
	* 62：（可跳过）运算符简介
	* 63：除法、取摸、++
	* 64：（重点）i++面试题
	* 65～67：（可跳过）运算符案例
	...
	* 84：（可跳过）关键字、保留字
	* 85：（重要）键盘输入：[[../notes/stage1/keyboard-input|keyboard-input]]
	...
	* 102：第三章总结
* 第 5 章：[branch-control](../notes/stage1/branch-control.md)
	* 103：顺序控制
	...
	* 153：总结
* 第 6 章：[array](../notes/stage1/array.md)，[[../notes/stage1/排序|排序]]，[[../notes/stage1/查找|查找]]
	* 154：（可跳过）感慨
	* 155：（可跳过）数组的必要性
	* 156：（可跳过）数组的快速入门
	...
	* 189：内容梳理
* 第 7 章：[class-and-object-introduce](../notes/stage1/class-and-object-introduce.md) ，[attributes-and-methods](../notes/stage1/attributes-and-methods.md)，[recursion](../notes/stage1/recursion.md)，[this](../notes/stage1/this.md)
	* 190：（可跳过）鼓励
	* 191：（可跳过）类与对象的引出
	* 192：（可跳过）类与对象的概述
	* 193：面向对象快速入门
	...
	* 262：内容梳理
* 第 8 章：[package](../notes/stage1/package.md)，[Access Modifiers](../notes/stage1/access-modifiers.md)，[encapsulation](../notes/stage1/encapsulation.md)，[extends](../notes/stage1/extends.md)，[super](../notes/stage1/super.md)，[polymorphism](../notes/stage1/polymorphism.md)，[Object](../notes/stage1/Object.md)，[[../notes/stage1/断点调试]]
	* 263~271：IDEA软件
	* 272~277：包
	* 278~279：（重点）访问修饰符
	* 280~284：（重点）封装
...
* 第 10 章：[static](../notes/stage2/static.md)，[code-block](../notes/stage2/code-block.md)，[design partten](../../design-pattern/README.md)，[final](../notes/stage2/final.md)，[abstract](../notes/stage2/abstract.md)，[interface](../notes/stage2/interface.md)，[inner-class](../notes/stage2/inner-class.md)
	* 373~374：类变量的引出
	* 375：类变量内存布局
	* 376~377：类变量的使用与细节
	* 378~381：类方法+案例
	...
	* 402~411：（重点）接口
	* 412~424：（重点，难点）四种内部类
* 第 11 章：[enum](../../../../ai/python/library/enum/enum.md)，[[../notes/stage2/annotation]]
	* 423：枚举引出
	* 424：自定义类实现枚举
	* 425：enum 关键字实现枚举
	* 426：enum 注意事项
...
* 第 13 章：[WrapperClass](../notes/stage2/WrapperClass.md)，[String](../notes/stage2/String.md)，[Math](../notes/stage2/Math.md)，[Arrays](../notes/stage2/Arrays.md)，[BigIntegerBigDecimal](../notes/stage2/BigIntegerBigDecimal.md)，[[../notes/stage2/date|date]]
	* 459~464：包装类
	* 465~473：（重要）String
...
* 第 15 章：[generic](../notes/stage2/generic.md)
	* 553~554：泛型的引出
	* 555~559：泛型类型说明
	* 560~562：自定义泛型
	* 562~563：自定义泛型方法
...
* 第 16 章：（坦克大战项目第一部分）[Swing](../notes/stage2/Swing.md)
* 第 17 章：[multiy-threading](../notes/stage2/multiy-threading.md)
	* 589~580：线程与进程的一些概念
	* 581：线程案例
	* 582~586：线程两种创建方式
	* 587~590：线程常用方法
	...
	* 594：互斥锁
* 第 18 章：（坦克大战项目第二部分）
* 第 19 章：[io-stream](../notes/stage2/io-stream.md)
	...
	* 641~643：作业
* 第 20 章：（坦克大战项目第三部分）
* 第 21 章：[[../notes/stage3/network|network]]
	* 661~665：网络相关概念；IP；域名，端口号，TCP/IP协议栈，TCP、UDP
	* 666：INetAddress类
	* 667~670：TCP编程实践
* 动力节点补充：[[../notes/powerpoint/jvm]]，[[../notes/powerpoint/principle]]，[[../notes/powerpoint/uml]]，[[../notes/powerpoint/re]]，[[../notes/powerpoint/uuid]]，[[../notes/powerpoint/System|System]]，[reflect](../notes/powerpoint/reflect.md)，[[../notes/powerpoint/lambda]]，[stream](../notes/powerpoint/stream.md)
