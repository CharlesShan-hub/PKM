...
- 新版本更新详细内容：[java_new](pkm/backend/java/javase/notes/powerpoint/java_new.md)
...
![Java-basic-branch.excalidraw](pkm/backend/java/javase/assets/java-basic-branch.excalidraw.md)
...
![Java-basic-core.excalidraw](pkm/backend/java/javase/assets/java-basic-core.excalidraw.md)
