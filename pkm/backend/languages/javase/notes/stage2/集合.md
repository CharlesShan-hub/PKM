...
![[../../oldassets/Collection-drawing.excalidraw|1000]]

`Collection` 和 `Iterable` 接口 API 案例

![[../../oldassets/Collection-interface-drawing.excalidraw|1000]]

`ArrayList`，`LinkedLisk`，`Vector` 对比

![[../../oldassets/list-drawing.excalidraw|1000]]

`HashSet` 与 `LinkedHashSet`

![[../../oldassets/hashset-drawing.excalidraw|1000]]
`Map`

![[../../oldassets/map-drawing.excalidraw|1000]]
...
* 如果指定了类型（[generic](../03-oop-advanced/generic.md)）那就只能传入特定的类型了
    ```java
    List<String> names = new ArrayList<>();
    ```
