...
1. 成员变量：[attributes-and-methods](../02-oop/attributes-and-methods.md)
2. 构造器：[attributes-and-methods](../02-oop/attributes-and-methods.md)
3. 方法：[attributes-and-methods](../02-oop/attributes-and-methods.md)
4. 代码块：[code-block](../03-oop-advanced/code-block.md)
5. 内部类：本文
---
## 概述
...
比较常用的就是对数组进行排序的时候，自定义排序方法。详见：[Comparator](../04-utils/Comparator.md)
