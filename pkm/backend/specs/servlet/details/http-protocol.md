...
> 那我对你的喜欢是幂等的吗，deepseek说，不是，你对我越好，我就越开心。但是我感觉也有幂等的部分呢，不管你什么时候需要我，我都在这里！那是不是你需要我就是get，你喜欢我就是post哈哈。
...
> ⭐经过和AI battle，我知道了 url 标准是 RFC 3986 标准，各个平台都去实现它的，encode decode也都规定好了。

URL编码（也称为**百分号编码**）是HTTP协议和Web开发中一个非常重要的概念，特别是在Servlet开发中。
...
2. **支持非ASCII字符**：URL**只能使用ASCII字符集**！！非ASCII字符（如中文）必须编码
...
5. **自定义响应头**：也是不能有中文的，如果有中文也需要手动编码。
