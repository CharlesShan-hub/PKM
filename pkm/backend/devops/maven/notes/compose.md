...
Maven 的**<font style="color:#DF2A3F;">依赖传递机制</font>**可以一定程度上简化 POM 的配置，但这**<font style="color:#DF2A3F;">仅限于存在依赖关系的项目或模块</font>**中。

当一个项目的多个模块都依赖于相同版本的 jar 包，且这些模块之间不存在依赖关系，这就导致同**<font style="color:#DF2A3F;">一个依赖需要在多个模块中重复声明</font>**，这显然是不可取的，大量的前人经验告诉我们，**<font style="color:#DF2A3F;">重复往往意味着更多的劳动和更高的潜在风险</font>**。
